...
export class ProfileProvider {
  ...
  public importWallet(str: string, opts: any): Promise<any> {
    return new Promise((resolve, reject) => {
      ...
      if (!strParsed.n) {
        return reject("Backup format not recognized. If you are using a DigiByteGo Beta backup and version is older than 0.10, please see: https://github.com/bitpay/copay/issues/4730#issuecomment-244522614");
      }
