...
export class BackupRequestPage {
  ...
  doBackupLater(confirmed: boolean) {
    ...
    this.opts.message = !confirmed ? 'If this device is replaced or this app is deleted, neither you nor the DigiByte Foundation can recover your funds without a backup.' : 'You can create a backup later from your wallet settings.';
    this.opts.buttons = [{
      text: 'Go back',
      role: 'destructor'
    },
